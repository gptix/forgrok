...
This node is the single source of truth that Grok will load at the start of every session via the exported Markdown file.

**Last Updated:** [2026-03-25 Wed] (we will update this automatically)

**Status:** Initial seed node — ready for first population.

* Active Projects & Goals
(No projects yet — we will add them today.)
...
**Machines & Access Patterns:**

**Software & Tools (pinned versions):**
