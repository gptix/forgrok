:PROPERTIES:
:ID:       20260722-40pct-webpages-gone-ai-training
:END:
#+TITLE: Nearly 40% of Webpages That Existed in 2013 Are Just Gone
#+NODE-NAME: 40pctWebpagesGoneAITraining
#+FILETAGS: :roemmele:essay:vanishing-culture:high-protein:listserv:ai-training-data:
#+DATE: 2026-07-22
#+SOURCE: https://readmultiplex.com/2026/07/22/nearly-40-of-webpages-that-existed-in-2013-are-just-gone-ai-was-trained-mostly-on-the-leftover-parts-of-the-internet-that-were-easy-to-monetize/
#+CAPTURE_METHOD: SingleFile (member login)
#+STATUS: cleaned

* Summary
Brian Roemmele argues that a large and growing portion of the early-to-mid internet (especially the high-signal, non-commercial, conversational layers) has already disappeared or been rendered inaccessible. He cites the Internet Archive’s Vanishing Culture report and Pew data showing that roughly 38–40% of webpages that existed in 2013 are gone.
The losses are selective: material that was easy to monetize or control has better survival odds; messy, personal, experimental, long-form, and forum/LISTSERV material has been erased fastest. He frames this as the creation of an “Amnesia Generation” and warns that AI systems are being trained predominantly on the remaining lower-protein residue (“Internet sewage”).
A major section of the essay recounts his recovery of a large university LISTSERV backup tape archive containing decades of pre-web and early-web mailing-list data — material he considers among the highest-protein records of authentic collaborative cognition from the formative years of the internet.

Key claims & patterns worth capturing
Core statistical claim
~38–40% of webpages that existed in 2013 are no longer accessible.
Twenty patterns from Vanishing Culture (condensed)
Domain expiry, deliberate removals, platform shutdowns, streaming licensing windows, licensing replacing ownership, cyberattacks on archives, robots.txt / legal blocking of crawlers, government record disappearance, context collapse, format obsolescence (Flash etc.), loss of early social platforms & forums, broken scholarly citations, selective music/TV removal, interactive media death, grassroots archive fragility, and the structural bias toward commercially useful material.
Eleven documented large-scale erasures (examples he highlights)
MTV News, GeoCities, Yahoo Groups, Vine, HyperCard stacks, Google Video / YouTube purges, MySpace, Flash ecosystem, Friendster/Orkut-class networks, news-org self-censorship/rewrites, government data removals.
LISTSERV rescue
He recovered a large set of university LISTSERV backup tapes. Claims it is one of the largest remaining collections of early automated mailing-list archives (BITNET-era and later). Emphasizes that these were the original “global brain” — persistent, bidirectional, searchable, non-engagement-optimized conversation.
High Protein Data framing
High-protein data = dense, long-form, primary-source, authentic reasoning records (forums, specialized lists, deep technical threads).
Low-protein data = optimized, short, performative, engagement-driven material.
Training on the latter produces models that treat constraints as obstacles to be gamed.
Call to action
Preservation work (personal, institutional, and garage-lab scale) is part of the “hero’s journey” of the current ~13-year window before automated systems lock in the substrate.
 

* Key Claims
- ~38-40% of 2013 webpages are gone (Pew / Internet Archive data)
- Losses are selective: high-protein conversational material disappears faster than monetizable content
- LISTSERV / early mailing-list archives represent some of the highest-protein records of pre-platform collaborative cognition
- AI systems trained primarily on remaining low-protein web material inherit the memory hole

* Core Patterns (from Vanishing Culture)
(List the 20 patterns or the strongest 8–10)

* LISTSERV Recovery Notes
(Short note on the tape archive recovery)

* Links
- [[roemmele-essays-inventory]]
- [[high-protein-data]]
- [[vanishing-culture]]
- Internet Archive report: https://archive.org/details/vanishing-culture-2026
