...
- Light cleanup of 06-raw/ begun; 99-archive/ pass started
- Transitional top-level directories still present (inbox/, org-roam-knowledge/, grok-memory/) — triage pending

## 3. Open / Parked Items

1. Local Ollama SOUL.md loading bug (reported)
2. Further cleanup / triage of 06-raw/ and 99-archive/
...
- Land this CURRENT.md and update BOOT.md pointer
- Decide fate of transitional top-level directories
