#+TITLE: Joji - Grok Project Memory (Tsuioku Master Memory)
#+AUTHOR: Joji Teira + Grok (with team: Harper, Benjamin, Lucas)
#+DATE: <2026-04-09 Thu>
#+STARTUP: overview
...
## File System Layout (v2026-04-09)

Root: `~/joji-grok-wiki/` (or wherever you keep the project)

├── inbox/                  # ← Drop any new source files here for ingestion
│   └── (any file type: .md, .pdf, .txt, .org, images, etc.)
│
├── raw/                    # ← Immutable originals after successful ingestion
│   └── YYYY-MM-DD_hash-filename.ext   # (auto-renamed with date + hash for safety)
│
├── wiki/                   # ← The living, synthesized knowledge base
│   ├── index.md            # Master catalog of all concepts/entities
│   ├── log.md              # Chronological audit trail of every ingest & update
│   ├── GROK-SCHEMA.md      # Exact rules for how Grok maintains the wiki
│   ├── [entity pages].md   # Synthesized pages (People, Projects, Concepts, etc.)
│   └── ...
│
├── joji-grok-project-memory.md   # ← This master file (you are here)
...
* Related Nodes
- [[joji-grok-project-memory.md][Tsuioku Master Memory (Authoritative Source)]]
- [[tsuioku-memory-management-cycle.md][Tsuioku Memory Management Cycle]]
- [[withnail-hermes-pi.md][Project Withnail – Hermes v0.4.0 Autonomous CEO]]
...
- Zero@Home / ZHC-RPG Integration Readiness (April 09, 2026)
  ...
  * 2026-04-15 Session Close (post-dinner restart planned)
- Ingested: joji-hardware-inventory.org (permanent hardware reference)
- Ingested: karpathy-wiki-as-foundational-truth-gist-correction-2026-04.org
- Karpathy 5000 Days clarified as Roemmele; Karpathy gist confirmed as wiki-seed
- All prior state (GROK-SCHEMA v2.0, V-K 2.0, scaffolding phases) verified 100%
- Next: resume after dinner with user-provided restart prompt
